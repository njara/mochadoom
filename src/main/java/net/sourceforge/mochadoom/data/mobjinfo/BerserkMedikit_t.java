...
public class BerserkMedikit_t extends Misc_t {
  public BerserkMedikit_t(int doomednum, StateNum spawnstate, int spawnhealth, StateNum seestate, sfxenum_t seesound,
